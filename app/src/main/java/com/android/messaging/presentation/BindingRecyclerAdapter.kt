 ...
 */
class BindingRecyclerAdapter<T>(private val itemListener: SingleLiveEvent<T>) : me.tatarka.bindingcollectionadapter2.BindingRecyclerViewAdapter<T>() {
    ...
    companion object {
        val TAG = "BindingRecyclerAdapter"
    }
}
